    ...
    <v-list>
      ...
      >
        ...
        >
          ...
          <v-list-item-content>
             <router-link class="link" to="/trending" >
        ...
        >
          ...
          <v-list-item-content>
             <router-link class="link" to="/trending" >
            <v-list-item-title>Top Ratde</v-list-item-title>
             </router-link>
          </v-list-item-content>
...
<v-list-item-group>
        ...
        >
          ...
          <v-list-item-content>
             <router-link class="link" to="/trending" >
            <v-list-item-title> On tv</v-list-item-title>
             </router-link>
          </v-list-item-content>
...
<v-list-item>
      <v-list-item-content>
        <router-link class="link" to="/login" > <v-list-item-title>Popular Movies</v-list-item-title> </router-link>
    ...
    <v-list-item two-line>
      <router-link class="link"  to="/login" >
      <v-list-item-content>
        <v-list-item-title >Popular TV Shows</v-list-item-title>
      </v-list-item-content>
      </router-link>
    </v-list-item>
     <v-list-item two-line>
...
<v-list-item two-line>
   <router-link class="link" to="/login" >
      <v-list-item-content>
        <v-list-item-title>Showing Now</v-list-item-title>
      </v-list-item-content>
       </router-link>
    </v-list-item>
